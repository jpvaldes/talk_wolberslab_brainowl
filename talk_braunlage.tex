...
\begin{frame}
    ...
    This is a middle-point solution between a sparse and a dense solution.
    Highlight whole relevant areas involved in category discrimination and not
    scattered voxels.
...
\end{frame}
\begin{frame}
    \frametitle{BrainOwl, real fMRI task}
